...
$acc_username = "Jamelmontaron";
$acc_password = "jamjam";
$acc_fullname = "Jamel Vanguardia Montaron";
$acc_address = "Daig Boac Marinduque";

$url_add = "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];

if(isset($_REQUEST['login_button']) === true){
		if($_REQUEST['form_username'] != $acc_username){
			header("Location: ".$url_add."?DoesNotExist");
				...
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['DoesNotExist'])===true){
		      						echo "<div class='alert alert-danger' role='alert'> Wrong username try again... </div>";
		      				...
		      				echo "<div class='alert alert-success' role='alert'> Redirecting to Main page... </div>";
		      				header ("Refresh: 5; url=account.php");

		      			}else if (isset($_REQUEST['logout'])===true){

		      						echo "<div class='alert alert-info' role='alert'> Thank you for your visit... </div>";
		      			} else if (isset($_REQUEST['loginfirst'])===true){
		      						echo "<div class='alert alert-info' role='alert'> Hey! Please Login First. </div>";
		      			} else if (isset($_SESSION['ses_username'])===true){
		      						echo "<div class='alert alert-warning' role='alert'> Hey, You are still Logged in. Click <a href='account.php'> here to proceed. </div>";
		      			}
